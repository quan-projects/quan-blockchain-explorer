...
//$ch = curl_init('http://remote-nbr-002.niobioco.in:8314/json_rpc');
$ch = curl_init('http://remote-nbr-001.niobioco.in:8314/json_rpc');
...
//$ch2 = curl_init('http://173.212.234.87:8314/json_rpc');
$ch2 = curl_init('http://80.241.215.133:8314/json_rpc');
